...
@Injectable()
export class CertificationConsoleService {
    ...
    certifyRegistrationInformation(model: any) {
        const url = `${webapibaseurl}api/registration/certifyRegistrationInformation`;
