...
export class ImageComponent implements OnInit {
  ...
  constructor(private service: ImageService, private route: ActivatedRoute, private router: Router, private fb: FormBuilder, private http: HttpClient, ) { }
  ...
  onSubmit(htmlnote) {
    ...
    this.service.createabout(this.data).subscribe(result => {
      alert('About Us SuccessFully Created');
      console.log('success')
